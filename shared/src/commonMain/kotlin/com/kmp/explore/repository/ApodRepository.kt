...
interface ApodRepository {
    ...
    suspend fun getApodByDate(date: String): Result<ApodResponse> // Add this method for Find tab
...
class ApodRepositoryImpl(
    ...
    override suspend fun getApodByDate(date: String): Result<ApodResponse> {
        return try {
            val response = apiService.getApodByDate(date) // You'll need to add this method to ApodApiService
            Result.success(response)
        } catch (e: Exception) {
            Result.failure(e)
        }
